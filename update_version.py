...
def main():
  ...
  plistpath = scriptpath + "/resources/BizzareDelay-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/BizzareDelay-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/BizzareDelay-OSXAPP-Info.plist"
...
#   plistpath = scriptpath + "/resources/BizzareDelay-IOSAPP-Info.plist"
...
#   plistlib.writePlist(iosapp, plistpath)
  ...
  plistpath = scriptpath + "/installer/BizzareDelay.packproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/BizzareDelay.iss",inplace=1):
